...
export class AdminUserAddComponent implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<AdminUserAddComponent>,
  ...
  addUser(){
    ...
    // this.newUser.accountno = form.get('accountno').value;
    // this.newUser.accountstatement = form.get('accountstatement').value;
    // this.newUser.accounttype = form.get('accounttype').value;
    this.newUser.referral = form.get('referral').value;
    this.newUser.password = form.get('password').value;
    this.newUser.contactemail = form.get('email').value;
    // this.newUser.contactaddress = form.get('address').value;
    this.newUser.contactmobile = form.get('phone').value;
    // this.newUser.bvnverify = form.get('bvn').value == null ? false:true;
    // this.newUser.active = form.get('active').value == null ? false:true;
    // this.newUser.status = form.get('status').value;
    // this.newUser.stateorigin = form.get('state').value;
    // this.newUser.lga = form.get('lga').value;
    // this.newUser.cardstatus = form.get('card').value == null ? false:true;
    this.newUser.gender = form.get('gender').value;
    this.newUser.name = form.get('name').value;
    // this.newUser.photograph = form.get('photograph').value;
    // this.newUser.workid = form.get('work_id').value;
    // this.newUser.regCompleted = form.get('reg').value == null ? false:true;
