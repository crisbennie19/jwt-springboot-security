...
import { ManualFundingComponent } from "./views/manual-funding/manual-funding.component";
import { IncomeComponent } from "./views/manual-funding/income/income.component";
